...
const projects = [
  {
    ...
    description: "A personalized perfume assistant available in GPT store",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "https://chatgpt.com/g/g-tFBsvnYSj-scentgpt",
    Githublink: "https://chatgpt.com/g/g-tFBsvnYSj-scentgpt",
  },
  {
    title: "Chess Engine",
        ...
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            ...
            <div class="data">
              <div class="content">
              <div class="title-div">
                <h1 class="title"><a href="https://chatgpt.com/g/g-tFBsvnYSj-scentgpt">${title}</a></h1>
                <p class="description"><a href="https://chatgpt.com/g/g-tFBsvnYSj-scentgpt">${description}</a></p> 
                </div>
